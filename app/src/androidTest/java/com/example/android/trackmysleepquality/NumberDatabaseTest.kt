...
class NumberDatabaseTest {

    private lateinit var numberDao: NumberDatabaseDao
    ...
    fun createDb() {
        ...
        // process is killed.
        db = Room.inMemoryDatabaseBuilder(context, NumberDatabase::class.java)
                // Allowing main thread queries, just for testing.
                .allowMainThreadQueries()
                .build()
        numberDao = db.numberDatabaseDao
    }
